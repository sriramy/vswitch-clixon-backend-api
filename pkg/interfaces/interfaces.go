...
import (
	...
	ygen "github.com/sriramy/vswitch-api/pkg/gen"
)
...
func main() {
	...
	i.AdminStatus = ygen.IETFInterfaces_Interfaces_Interface_AdminStatus_up
	...
	d.Interface["eth1"] = &ygen.Interfrface{
		Name:        ygot.String("eth1"),
		Description: ygot.String("Another Interface"),
		Enabled:     ygot.Bool(false),
		Type:        ygen.IETFInterfaces_InterfaceType_ethernetCsmacd,
	}
	...
	loadd := &ygen.Device{}
	if err := ygen.Unmarshal([]byte(json), loadd); err != nil {
